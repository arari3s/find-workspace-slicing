...
function Details(): React.JSX.Element {
        ...
        return (
            <View style={styles.titleContainer}>
                ...
                <View style={[Gs.flexRow]}>
                    ...
                    />
                    <Text style={[Gs.textBlack, Gs.h4]}>4.5/5</Text>
                </View>
            </View>
        );
    };
    ...
    const renderDescription = () => {
        return (
            <View style={styles.descriptionContainer}>
                ...
                <Text style={[Gs.textGrey]}>
                    Lorem space curated dolor si amet deep work without
                    distraction from any edge si solor. Fiesto si fast charging
                    club and go-getter Internet zonn absurb prixomoti anneheil
                    available today.
                </Text>
            </View>
        );
    ...
    const renderOwner = () => {
        return (
            <View style={styles.ownerContainer}>
                <Text style={[Gs.textBlack, Gs.h3, styles.title]}>
                    Space Owner
                </Text>
                <View style={[Gs.flexRow, Gs.itemsCenter]}>
                    ...
                    <View>
                        <View style={[Gs.flexRow]}>
                            <Text style={Gs.textBlack}>Arlan</Text>
                            <Image
                                source={require('../../../assets/icons/verified_orange.png')}
                                style={styles.icon}
                            />
                        </View>
                        <Text style={[Gs.font700, Gs.textBlack]}>
                            @arlanariandi
                        </Text>
                    </View>
                </View>
    ...
    const renderBookingButton = () => {
        return (
            <View style={styles.bookingController}>
                <View>
